        ...
        body: Column(
          children: [
            ...
            Obx(() => GestureDetector(
                  ...
                  onTap: () {
                    TDPicker.showDatePicker(context, title: "选择年月日",
                        onConfirm: (selected) {
                      selected3.value =
            ...
            Obx(() => GestureDetector(
                ...
                onTap: () {
                  TDPicker.showDatePicker(context, title: "选择时分秒",
                      onConfirm: (selected) {
                    selected3.value =
                        "${selected["hour"].toString().padLeft(2, "0")}-${selected["minute"].toString().padLeft(2, "0")}-${selected["second"].toString().padLeft(2, "0")}";
                  },
                      dateStart: [2020, 01, 01],
                      dateEnd: [2025, 12, 31],
                      initialDate: [2023, 10, 01],
            ...
            Obx(() => GestureDetector(
                  ...
                  onTap: () {
                    TDPicker.showMultiLinkedPicker(context, title: "三级联动",
                        onConfirm: (selected) {
                      selected5.value =
